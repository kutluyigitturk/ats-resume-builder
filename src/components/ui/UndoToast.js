...
export default function UndoToast({ message, name, actionLabel = "Undo", onAction, onDismiss }) {
  ...
  return (
    <div
      ...
      role="status"
      className="undo-toast fixed bottom-6 left-1/2 z-50 flex max-w-[min(30rem,calc(100vw-2rem))] -translate-x-1/2 items-center gap-3 rounded-2xl border border-slate-200/70 py-2.5 pr-2.5 pl-4"
      style={{
        background: "#fff",
