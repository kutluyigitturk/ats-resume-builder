...
// Eliminates ~300 lines of duplicated inline SVGs across the project
...
export function MoveUpIcon({ size = 16 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function MoveDownIcon({ size = 16 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function GripVerticalIcon({ size = 10 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function VolunteeringIcon({ size = 20 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function CertificationIcon({ size = 20 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function LanguagesIcon({ size = 20 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function TemplatesIcon({ size = 14 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ─── Layout & Style Icons ────────────────────────────────────
export function FontsIcon({ size = 14 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function ListOrderedIcon({ size = 20 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function MarginsIcon({ size = 20 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ─── Contact Icons (for Advanced template preview) ───────────

export function MailIcon({ size = 12 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function PhoneIcon({ size = 12 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function MapPinIcon({ size = 12 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function FileTextIcon({ size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function RenameIcon({ size = 15 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function DuplicateIcon({ size = 15 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ResumeAnalysisIcon({ size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TrashOutlineIcon({ size = 15 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function RedoIcon({ size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
// ─── Ongoing Date Toggle ─────────────────────────────────────
//
// A ticked calendar means the entry is still running and the resume prints
// "Present"; a crossed one means it has an end date to type.

export function CalendarCheckIcon({ size = 15 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function CalendarXIcon({ size = 15 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function UserXIcon({ size = 18 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function AwardIcon({ size = 16 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// The filled SettingsIcon above is a 16-box gear that sits beside other filled
// glyphs in the builder toolbar. The account menu is all stroke icons, so it
// needs the stroke cut rather than a heavier shape in the middle of the list.
export function SettingsOutlineIcon({ size = 18 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function CropIcon({ size = 18 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function RotateLeftIcon({ size = 16 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function RotateRightIcon({ size = 16 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ─── Solid set ────────────────────────────────────
//
// The account page's reference uses filled glyphs, not stroke ones, and side
// by side that is the difference you feel first. These are fill-only: no
// stroke, so they take their colour from `color` like the outline set does.

export function MailSolidIcon({ size = 30 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function LockSolidIcon({ size = 30 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function DollarSolidIcon({ size = 30 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function CreditCardSolidIcon({ size = 30 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function HomeSolidIcon({ size = 24 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function FileSolidIcon({ size = 24 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function PencilSolidIcon({ size = 20 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function AlertTriangleSolidIcon({ size = 20 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
